...
//console.log (returnArray ("tim", "hortons", "donut"))
...
function splitArray (thisArray) {
  ...
  // array[1]
  // etc.
//let splitArray = ["Tony", " Yi", "student"], 
  let splitArray = thisArray [0] + ' ' + thisArray [1] + ' was a ' + thisArray [2] + '.';
  return splitArray; 
}
//console.log (splitArray (["tim", "horton", "donut"]))
